...
print("Example 1 Loss Elements:", loss_elem_(y1, y_hat1))
print("Example 1 Loss:", loss_(y1, y_hat1))

x2 = np.array([0, 15, -9, 7, 12, 3, -21]).reshape(-1, 1)
theta2 = np.array([[0.0], [1.0]])
y_hat2 = predict_(x2, theta2)
y2 = np.array([2, 14, -13, 5, 12, 4, -19]).reshape(-1, 1)
print("Example 2 Loss:", loss_(y2, y_hat2))

print("Example 3 Loss:", loss_(y2, y2))
